...
# ./proot-arm64 -0 -r ./small+FileSystem -w /root 

# proot -0 -r ./small+FileSystem -w /root --bind=/data/data/com.termux/files/usr --bind=/data/data/com.termux/files/home --bind=/data/data/com.termux/cache --bind=/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/small+/tmp:/dev/shm 
